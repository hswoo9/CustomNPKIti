$(function(){
	...
	$(document).ready(function(){
		...
		// 서브페이지 상세검색 slideToggle  (각모듈별로 폴더경로 절대주소로 바꿔주세요.)
		$(".SearchDetail").hide();
	   ...
	   // 업무,할일 좌측 상세검색 slideToggle 로컬코드 (각모듈별로 폴더경로 절대주소로 바꿔주세요.)
        $(".btn_Detail2").click(function(){
            $(".um_dtl").slideToggle("slow");
            if($('.btn_Detail2 img').attr('src')=='../../../Images/ico/ico_btn_arr_down01.png'){
                $('.btn_Detail2 img').attr('src','../../../Images/ico/ico_btn_arr_up01.png');
            }else{
                $('.btn_Detail2 img').attr('src','../../../Images/ico/ico_btn_arr_down01.png');
            }
       });	
