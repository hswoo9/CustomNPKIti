		...
		<div class="top_box">
			<dl>
				...
				<dd>
					...
					<input type="hidden" id="userSeq" disabled="disabled" value="${userInfo.empSeq }" /> 
	...
	function gridExcel() {
		...
		rows.push({
	      ...
	      ds.fetch(function(){
	        ...
	        kendo.saveAs({dataURI: workbook.toDataURL(), fileName: $('#empName').val()+'_'+$('#monthpicker').val()+"월 근태현황.xlsx"});
